/*
This program is a collection of recipes for different dishes
1 - choose dish category
2 - choose one of the available dishes
3 - after all these steps, program will output a recipe for chosen dish and ingredients necessary to make it

(all recipes in this program are from www.kwestiasmaku.com website)
"""
"""
zupy:
zupa ogorkowa
...
int main() {
    ...
    // program creates variables to store chosen dish name and dish category
    string category;
    string dish;
    // program outputs a list of available dish categories and outputs an information if mentioned category is unavailable
    cout << "available dish categories: \nsoup\nmain course with meat\nmain course without meat\ndessert\ntype dish category: ";
    getline(cin, category);
    // program outputs a list of available dishes from chosen category, takes dish name from user's input and outputs a recipe with a list of necessary ingredients. If user types a name of unavailable dish, program outputs an information about it
    if(category == "soup") {
        cout << "available soups:\nzupa ogorkowa\nzupa pomidorowa\nrosol\nbarszcz czerwony\nbarszcz bialy\nwpisz nazwe potrawy: ";
        getline(cin, dish);
        if(dish == "zupa ogorkowa") {
            cout << "skladniki: \n" << skladniki[0][1] << "\n\n" << przepisy[0][1];
        } else if(dish == "zupa pomidorowa") {
            cout << "skladniki: \n" << skladniki[1][1] << "\n\n" << przepisy[1][1];
        } else if(dish == "rosol") {
            cout << "skladniki: \n" << skladniki[2][1] << "\n\n" << przepisy[2][1];
        } else if(dish == "barszcz czerwony") {
            cout << "skladniki: \n" << skladniki[3][1] << "\n\n" << przepisy[3][1];
        } else if(dish == "barszcz bialy") {
            cout << "skladniki: \n" << skladniki[4][1] << "\n\n" << przepisy[4][1];
        } else {
            cout << "you chose unavailable recipe";
        }
    } else if(category == "main course with meat") {
        cout << "available dishes with meat:\ngolabki\npulpety\nkotlety mielone\nkotlety schabowe z pieczarkami\npierogi z miesem\nwpisz nazwe potrawy: ";
        getline(cin, dish);
        if(dish == "golabki") {
            cout << "skladniki: \n" << skladniki[5][1] << "\n\n" << przepisy[5][1];
        } else if(dish == "pulpety") {
            cout << "skladniki: \n" << skladniki[6][1] << "\n\n" << przepisy[6][1];
        } else if(dish == "kotlety mielone") {
            cout << "skladniki: \n" << skladniki[7][1] << "\n\n" << przepisy[7][1];
        } else if(dish == "kotlety schabowe z pieczarkami") {
            cout << "skladniki: \n" << skladniki[8][1] << "\n\n" << przepisy[8][1];
        } else if(dish == "pierogi z miesem") {
            cout << "skladniki: \n" << skladniki[9][1] << "\n\n" << przepisy[9][1];
        } else {
            cout << "you chose unavailable recipe";
        }
    } else if(category == "main course without meat") {
        cout << "available dishes without meat:\nnalesniki\npierogi z serem i jagodami\npierogi z kapusta i grzybami\npierogi ruskie\nkotlety jajeczne z kasza\nwpisz nazwe potrawy: ";
        getline(cin, dish);
        if(dish == "nalesniki") {
            cout << "skladniki: \n" << skladniki[10][1] << "\n\n" << przepisy[10][1];
        } else if(dish == "pierogi z serem i jagodami") {
            cout << "skladniki: \n" << skladniki[11][1] << "\n\n" << przepisy[11][1];
        } else if(dish == "pierogi z kapusta i grzybami") {
            cout << "skladniki: \n" << skladniki[12][1] << "\n\n" << przepisy[12][1];
        } else if(dish == "pierogi ruskie") {
            cout << "skladniki: \n" << skladniki[13][1] << "\n\n" << przepisy[13][1];
        } else if(dish == "kotlety jajeczne z kasza") {
            cout << "skladniki: \n" << skladniki[14][1] << "\n\n" << przepisy[14][1];
        } else {
            cout << "you chose unavailable recipe";
        }
    } else if(category == "dessert") {
        cout << "available desserts:\nsernik\ntarta ze sliwkami\npiernik czekoladowy\nszarlotka\nbrownie\nwpisz nazwe potrawy: ";
        getline(cin, dish);
        if(dish == "sernik") {
            cout << "skladniki: \n" << skladniki[15][1] << "\n\n" << przepisy[15][1];
        } else if(dish == "tarta ze sliwkami") {
            cout << "skladniki: \n" << skladniki[16][1] << "\n\n" << przepisy[16][1];
        } else if(dish == "piernik czekoladowy") {
            cout << "skladniki: \n" << skladniki[17][1] << "\n\n" << przepisy[17][1];
        } else if(dish == "szarlotka") {
            cout << "skladniki: \n" << skladniki[18][1] << "\n\n" << przepisy[18][1];
        ...
        cout << "you chose unavailable dish category";
    }
    return 0;
}